 ...
 */
v2.$msg({
  'alpha': '${field} får enbart innehålla bokstäver',
  ...
  'url': '${field} måste vara en giltig URL',
  'word': '${field} får enbart innehålla bokstäver, siffor och/eller interpunktion',
  'phone-se': '${field} måste vara ett giltigt telefonnummer',
  'ssn-se': '${field} måste vara ett giltigt personnummer',
  'orgn-se': '${field} måste vara ett giltigt organisationsnummer'
});
